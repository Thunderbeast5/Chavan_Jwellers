                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {form.images.map((url, index) => (
                                        <div key={index} className="relative">
                                            <img src={url} alt={`Product image ${index + 1}`} className="w-full h-20 object-cover rounded" />
                                            <button
                                                type="button"
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {items.map((p) => (
                                <div key={p.id} className="flex items-center gap-3 border-b pb-3">
                                    {p.images?.[0] ? <img src={p.images[0]} alt={p.name} className="w-14 h-14 object-cover rounded" /> : <div className="w-14 h-14 bg-gray-100 rounded" />}
